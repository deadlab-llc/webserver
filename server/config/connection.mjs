...
var DeadlabURI = (process.env.NODE_ENV==="production")?"mongodb://host.docker.internal:27017/deadlab":process.env.MONGO_DEADLAB_URI
var SwoggerslolURI=(process.env.NODE_ENV==="production")?"mongodb://host.docker.internal:27017/swoggerslol":process.env.MONGO_SWOGGERSLOL_URI
